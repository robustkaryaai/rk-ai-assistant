...
GEMINI_MODEL = os.getenv("GEMINI_MODEL", "gemma-3-9b-it")  # Fast model for low latency
...
GEMINI_MODEL_PRIMARY = os.getenv("GEMINI_MODEL_PRIMARY", "gemma-3-9b-it") # User requested Gemma 3 12B
